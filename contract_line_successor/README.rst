...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:e24cfe4bc30d41aea682f218cb66b02ba7fd41a184f762faeffd314f1def60f5
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
The contract lines list is colour-coded by their lifecycle **state** so
the status is readable at a glance (mirroring the contract list and
Odoo's own draft/expired conventions):

- **Upcoming** — blue (like a draft order), the line has not started
  yet.
- **In-progress** — normal, the line is currently running.
- **To renew** / **Upcoming close** — purple, the line needs attention
  before its end date (distinct from orange/warning, which is kept for
  real problems).
