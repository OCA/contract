...
class ContractLine(models.Model):
    ...
    def _check_overlap_successor(self):
        self = self.filtered(lambda l: not l.contract_id.use_invoice_plan)
        return super()._check_overlap_successor()

    def _check_overlap_predecessor(self):
        self = self.filtered(lambda l: not l.contract_id.use_invoice_plan)
        return super()._check_overlap_predecessor()

    def _check_auto_renew_canceled_lines(self):
        self = self.filtered(lambda l: not l.contract_id.use_invoice_plan)
        return super()._check_auto_renew_canceled_lines()

    def _check_recurring_next_date_start_date(self):
        self = self.filtered(lambda l: not l.contract_id.use_invoice_plan)
        return super()._check_recurring_next_date_start_date()
    ...
    def _check_recurring_next_date_recurring_invoices(self):
        self = self.filtered(lambda l: not l.contract_id.use_invoice_plan)
        return super()._check_recurring_next_date_recurring_invoices()
